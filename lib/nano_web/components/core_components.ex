defmodule NanoWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: NanoWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 theme-cta-btn",
        @class
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NanoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NanoWeb.Gettext, "errors", msg, opts)
    end
  end
